...
cityName = '全国'
data = 'params='+quote(json.dumps({"type":"getTime","cityName":cityName,"channelCode":"J0002","channelId":"3"},ensure_ascii=False).replace(' ',''))
...
data = 'params='+quote(json.dumps({"type":"totalCinema","cityName":cityName,"channelCode":"J0002","channelId":"3"},ensure_ascii=False).replace(' ',''))
...
data = 'params='+quote(json.dumps({"cinemaId":cinemaId,"showtime":"2017-01-18","type":"queryItemSku","memberLevelName":"","memberId":"","channelCode":"J0002","channelId":"3"},ensure_ascii=False).replace(' ',''))
