...
data_time = 'params='+quote(json.dumps({"type":"getTime","cityName":cityName,"channelCode":"J0002","channelId":"3"},ensure_ascii=False).replace(' ',''))

url_cinema = 'http://www.jycinema.cn/frontUIWebapp/appserver/cinCinemaMessageService/findCinema'
data_cinema = 'params='+quote(json.dumps({"type":"totalCinema","cityName":cityName,"channelCode":"J0002","channelId":"3"},ensure_ascii=False).replace(' ',''))

url_data  = 'http://www.jycinema.cn/frontUIWebapp/appserver/commonItemSkuService/findItemSku'
# cinemaId = str(cityid)#---->成都的id
data_data = 'params='+quote(json.dumps({"cinemaId":'446',"showtime":"2017-01-18","type":"queryItemSku","memberLevelName":"","memberId":"","channelCode":"J0002","channelId":"3"},ensure_ascii=False).replace(' ',''))
